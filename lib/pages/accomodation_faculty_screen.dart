...
class AccomodationFacultyScreen extends StatefulWidget {
  const AccomodationFacultyScreen({super.key});

  @override
  State<AccomodationFacultyScreen> createState() => _AccomodationFacultyScreenState();
}

class _AccomodationFacultyScreenState extends State<AccomodationFacultyScreen> {
